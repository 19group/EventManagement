...
class GenerateInvitationLetter extends Job implements ShouldQueue
{
    ...
    {
        Log::info("Generating invitation letter: #" . $reference);
    ...
    public function handle()
    {
        ...
        PDF::html('Public.ViewEvent.Partials.EventInvitationLetter', $data, $file_path);
        Log::info("Invitation Letters generated!");
    }
