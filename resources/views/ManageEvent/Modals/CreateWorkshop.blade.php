...
<div role="dialog"  class="modal fade" style="display: none;">
   {!! Form::open(array('url' => route('postCreateWorkshop', array('event_id' => $event->id)), 'enctype' => 'multipart/form-data')) !!}
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('title', 'Workshop Title', array('class'=>'control-label required')) !!}
                            {!!  Form::text('title', Input::old('title'),
                                        array(
                                        'class'=>'form-control',
                                        'placeholder'=>'E.g: Creating systems For Identifying Personality From Geographical Data'
                                        ))  !!}
                        </div>
                        ...
                        <div class="form-group">
                            {!! Form::label('description', 'Workshop Short Description', array('class'=>'control-label')) !!}
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <span class="btn btn-primary btn-file ">
                                            Browse… <input name="workshop_image" type="file" multiple="" onchange="readURL(this);">
                                        </span>
                                    </span>
            ...
            <div class="modal-footer">
               ...
               {!! Form::submit('Create Worshop', ['class'=>"btn btn-success"]) !!}
            </div>
...
<script>
  ...
  if (window.File && window.FileList && window.FileReader) {
    ...
    $('#add_schedule').on('click', function(e) {
        ...
        i.setAttribute("placeholder", "Start Time For Session" + scheduler);
        ...
        t.setAttribute("placeholder", "End Time For Session " + scheduler);
        p.appendChild(d);
        p.appendChild(f);
        d.appendChild(y);
        f.appendChild(z);
